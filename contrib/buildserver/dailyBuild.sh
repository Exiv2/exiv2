...
source=http://github.com/Exiv2/exiv2.git

ssh rmills@rmillsmm         'cd ~/gnu/exiv2/buildserver ; rm -rf exiv2 ; git clone $source ; cd exiv2/ ;                               contrib/buildserver/dailyCMake.sh'
ssh rmills@rmillsmm-kubuntu 'cd ~/gnu/exiv2/buildserver ; rm -rf exiv2 ; git clone $source ; cd exiv2/ ;                               contrib/buildserver/dailyCMake.sh'
ssh rmills@rmillsmm-w7      'cd ~/gnu/exiv2/buildserver ; rm -rf exiv2 ; git clone $source ; cd exiv2/ ;                               contrib/buildserver/dailyCMake.sh'
ssh rmills@rmillsmm-w7      'cd ~/gnu/exiv2/buildserver ; rm -rf exiv2 ; git clone $source ; cd exiv2/ ; env PLATFORM=msvc             contrib/buildserver/dailyCMake.sh'
