...
namespace Exiv2 {
    ...
    extern const XmpPropertyInfo xmpVideoInfo[] = {
        ...
        { "TagName",                N_("Tag Name"),                         "Text",                     xmpText, xmpExternal, N_("Tags could be used to deﬁne several titles for a segment.")   },
        ...
        { "TrackName",              N_("Track Name"),                       "Text",                     xmpText, xmpExternal, N_("Track Name could be used to deﬁne titles for a segment.")   },
