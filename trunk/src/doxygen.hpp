 ...
 */
/*!
  @mainpage Exif and Iptc metadata manipulation library and tools v0.9.1
...
bug tracking system</a>.</p>
  ...
  <p>To download the test data and test drivers for version 0.9.1 from
  the repository, change to your local exiv2-0.9.1 directory and use the
  following command:
  </p>
