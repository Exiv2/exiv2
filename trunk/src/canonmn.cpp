...
namespace Exiv2 {
    ...
    const TagInfo CanonMakerNote::tagInfoCs_[] = {
        ...
        TagInfo(0x0017, "Lens", N_("Lens"), N_("'long' and 'short' focal length of lens (in 'focal units') and 'focal units' per mm"), canonCsIfdId, makerTags, unsignedShort, 3, printCsLens),
        ...
        // End of list marker
        TagInfo(0xffff, "(UnknownCanonCsTag)", "(UnknownCanonCsTag)", N_("Unknown Canon Camera Settings 1 tag"), canonCsIfdId, makerTags, unsignedShort, 1, printValue)
    };
    ...
    const TagInfo CanonMakerNote::tagInfoSi_[] = {
        ...
        // End of list marker
        TagInfo(0xffff, "(UnknownCanonSiTag)", "(UnknownCanonSiTag)", N_("Unknown Canon Camera Settings 2 tag"), canonSiIfdId, makerTags, unsignedShort, 1, printValue)
    };
    ...
    const TagInfo CanonMakerNote::tagInfoPa_[] = {
        ...
        // End of list marker
        TagInfo(0xffff, "(UnknownCanonCs2Tag)", "(UnknownCanonCs2Tag)", N_("Unknown Canon Panorama tag"), canonPaIfdId, makerTags, unsignedShort, 1, printValue)
    };
    ...
    const TagInfo CanonMakerNote::tagInfoCf_[] = {
        ...
        // End of list marker
        TagInfo(0xffff, "(UnknownCanonCfTag)", "(UnknownCanonCfTag)", N_("Unknown Canon Custom Function tag"), canonCfIfdId, makerTags, unsignedShort, 1, printValue)
    };
    ...
    const TagInfo CanonMakerNote::tagInfoPi_[] = {
        ...
        // End of list marker
        TagInfo(0xffff, "(UnknownCanonPiTag)", "(UnknownCanonPiTag)", N_("Unknown Canon Picture Info tag"), canonPiIfdId, makerTags, unsignedShort, 1, printValue)
    };
    ...
    const TagInfo CanonMakerNote::tagInfoFi_[] = {
        ...
        // End of list marker
        TagInfo(0xffff, "(UnknownCanonFiTag)", "(UnknownCanonFiTag)", N_("Unknown Canon File Info tag"), canonFiIfdId, makerTags, signedShort, 1, printValue)
    };
    ...
    const TagInfo CanonMakerNote::tagInfoPr_[] = {
        ...
        TagInfo(0xffff, "(UnknownCanonPrTag)", "(UnknownCanonPrTag)", N_("Unknown Canon Processing Info tag"), canonPrIfdId, makerTags, signedShort, 1, printValue)
    };
