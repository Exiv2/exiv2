...
namespace Exiv2 {
                                               ...
                                               const Value& value)
    {
        ...
        //#-----------------------------------------
        //# List of AF F-Mount lenses - version 2.08
        //#-----------------------------------------
        //#
        ...
        fmountlens[] = {
            {0x01,0x58,0x50,0x50,0x14,0x14,0x02,0x00, N_("Nikon"), N_("AF Nikkor 50mm f/1.8")},
            {0x02,0x42,0x44,0x5C,0x2A,0x34,0x02,0x00, N_("Nikon"), N_("AF Zoom-Nikkor 35-70mm f/3.3-4.5")},
            {0x02,0x42,0x44,0x5C,0x2A,0x34,0x08,0x00, N_("Nikon"), N_("AF Zoom-Nikkor 35-70mm f/3.3-4.5")},
            {0x03,0x48,0x5C,0x81,0x30,0x30,0x02,0x00, N_("Nikon"), N_("AF Zoom-Nikkor 70-210mm f/4")},
            {0x04,0x48,0x3C,0x3C,0x24,0x24,0x03,0x00, N_("Nikon"), N_("AF Nikkor 28mm f/2.8")},
            {0x05,0x54,0x50,0x50,0x0C,0x0C,0x04,0x00, N_("Nikon"), N_("AF Nikkor 50mm f/1.4")},
            {0x06,0x54,0x53,0x53,0x24,0x24,0x06,0x00, N_("Nikon"), N_("AF Micro-Nikkor 55mm f/2.8")},
            {0x07,0x40,0x3C,0x62,0x2C,0x34,0x03,0x00, N_("Nikon"), N_("AF Zoom-Nikkor 28-85mm f/3.5-4.5")},
            {0x08,0x40,0x44,0x6A,0x2C,0x34,0x04,0x00, N_("Nikon"), N_("AF Zoom-Nikkor 35-105mm f/3.5-4.5")},
            {0x09,0x48,0x37,0x37,0x24,0x24,0x04,0x00, N_("Nikon"), N_("AF Nikkor 24mm f/2.8")},
            {0x0A,0x48,0x8E,0x8E,0x24,0x24,0x03,0x00, N_("Nikon"), N_("AF Nikkor 300mm f/2.8 IF-ED")},
            {0x0B,0x48,0x7C,0x7C,0x24,0x24,0x05,0x00, N_("Nikon"), N_("AF Nikkor 180mm f/2.8 IF-ED")},
            {0x0D,0x40,0x44,0x72,0x2C,0x34,0x07,0x00, N_("Nikon"), N_("AF Zoom-Nikkor 35-135mm f/3.5-4.5")},
            {0x0E,0x48,0x5C,0x81,0x30,0x30,0x05,0x00, N_("Nikon"), N_("AF Zoom-Nikkor 70-210mm f/4")},
            {0x0F,0x58,0x50,0x50,0x14,0x14,0x05,0x00, N_("Nikon"), N_("AF Nikkor 50mm f/1.8 N")},
            {0x10,0x48,0x8E,0x8E,0x30,0x30,0x08,0x00, N_("Nikon"), N_("AF Nikkor 300mm f/4 IF-ED")},
            {0x11,0x48,0x44,0x5C,0x24,0x24,0x08,0x00, N_("Nikon"), N_("AF Zoom-Nikkor 35-70mm f/2.8")},
            {0x12,0x48,0x5C,0x81,0x30,0x3C,0x09,0x00, N_("Nikon"), N_("AF Nikkor 70-210mm f/4-5.6")},
            {0x13,0x42,0x37,0x50,0x2A,0x34,0x0B,0x00, N_("Nikon"), N_("AF Zoom-Nikkor 24-50mm f/3.3-4.5")},
            {0x14,0x48,0x60,0x80,0x24,0x24,0x0B,0x00, N_("Nikon"), N_("AF Zoom-Nikkor 80-200mm f/2.8 ED")},
            {0x15,0x4C,0x62,0x62,0x14,0x14,0x0C,0x00, N_("Nikon"), N_("AF Nikkor 85mm f/1.8")},
            {0x17,0x3C,0xA0,0xA0,0x30,0x30,0x11,0x00, N_("Nikon"), N_("Nikkor 500mm f/4 P")},
            {0x18,0x40,0x44,0x72,0x2C,0x34,0x0E,0x00, N_("Nikon"), N_("AF Zoom-Nikkor 35-135mm f/3.5-4.5 N")},
            {0x1A,0x54,0x44,0x44,0x18,0x18,0x11,0x00, N_("Nikon"), N_("AF Nikkor 35mm f/2")},
            {0x1B,0x44,0x5E,0x8E,0x34,0x3C,0x10,0x00, N_("Nikon"), N_("AF Zoom-Nikkor 75-300mm f/4.5-5.6")},
            {0x1C,0x48,0x30,0x30,0x24,0x24,0x12,0x00, N_("Nikon"), N_("AF Nikkor 20mm f/2.8")},
            {0x1D,0x42,0x44,0x5C,0x2A,0x34,0x12,0x00, N_("Nikon"), N_("AF Zoom-Nikkor 35-70mm f/3.3-4.5 N")},
            {0x1E,0x54,0x56,0x56,0x24,0x24,0x13,0x00, N_("Nikon"), N_("AF Micro-Nikkor 60mm f/2.8")},
            {0x20,0x48,0x60,0x80,0x24,0x24,0x15,0x00, N_("Nikon"), N_("AF Zoom-Nikkor ED 80-200mm f/2.8")},
            {0x22,0x48,0x72,0x72,0x18,0x18,0x16,0x00, N_("Nikon"), N_("AF DC-Nikkor 135mm f/2")},
            {0x24,0x48,0x60,0x80,0x24,0x24,0x1A,0x02, N_("Nikon"), N_("AF Zoom-Nikkor ED 80-200mm f/2.8D")},
            {0x25,0x48,0x44,0x5c,0x24,0x24,0x1B,0x02, N_("Nikon"), N_("AF Zoom-Nikkor 35-70mm f/2.8D")},
            {0x25,0x48,0x44,0x5c,0x24,0x24,0x52,0x02, N_("Nikon"), N_("AF Zoom-Nikkor 35-70mm f/2.8D N")},
            {0x27,0x48,0x8E,0x8E,0x24,0x24,0xF2,0x02, N_("Nikon"), N_("AF-I Nikkor 300mm f/2.8D IF-ED")},
            {0x27,0x48,0x8E,0x8E,0x24,0x24,0x1D,0x02, N_("Nikon"), N_("AF-I Nikkor 300mm f/2.8D IF-ED")},
            {0x28,0x3C,0xA6,0xA6,0x30,0x30,0x1D,0x02, N_("Nikon"), N_("AF-I Nikkor 600mm f/4D IF-ED")},
            {0x2A,0x54,0x3C,0x3C,0x0C,0x0C,0x26,0x02, N_("Nikon"), N_("AF Nikkor 28mm f/1.4D")},
            {0x2C,0x48,0x6A,0x6A,0x18,0x18,0x27,0x02, N_("Nikon"), N_("AF DC-Nikkor 105mm f/2D")},
            {0x2D,0x48,0x80,0x80,0x30,0x30,0x21,0x02, N_("Nikon"), N_("AF Micro-Nikkor 200mm f/4D IF-ED")},
            {0x2E,0x48,0x5C,0x82,0x30,0x3C,0x28,0x02, N_("Nikon"), N_("AF Nikkor 70-210mm f/4-5.6D")},
            {0x2F,0x48,0x30,0x44,0x24,0x24,0x29,0x02, N_("Nikon"), N_("AF Zoom-Nikkor 20-35mm f/2.8(IF)")},
            {0x31,0x54,0x56,0x56,0x24,0x24,0x25,0x02, N_("Nikon"), N_("AF Micro-Nikkor 60mm f/2.8D")},
            {0x32,0x54,0x6A,0x6A,0x24,0x24,0x35,0x02, N_("Nikon"), N_("AF Micro-Nikkor 105mm f/2.8D")},
            {0x33,0x48,0x2D,0x2D,0x24,0x24,0x31,0x02, N_("Nikon"), N_("AF Nikkor 18mm f/2.8D")},
            {0x34,0x48,0x29,0x29,0x24,0x24,0x32,0x02, N_("Nikon"), N_("AF Fisheye Nikkor 16mm f/2.8D")},
            {0x36,0x48,0x37,0x37,0x24,0x24,0x34,0x02, N_("Nikon"), N_("AF Nikkor 24mm f/2.8D")},
            {0x37,0x48,0x30,0x30,0x24,0x24,0x36,0x02, N_("Nikon"), N_("AF Nikkor 20mm f/2.8D")},
            {0x38,0x4C,0x62,0x62,0x14,0x14,0x37,0x02, N_("Nikon"), N_("AF Nikkor 85mm f/1.8D")},
            {0x3B,0x48,0x44,0x5C,0x24,0x24,0x3A,0x02, N_("Nikon"), N_("AF Zoom-Nikkor 35-70mm f/2.8D N")},
            {0x3D,0x3C,0x44,0x60,0x30,0x3C,0x3E,0x02, N_("Nikon"), N_("AF Zoom-Nikkor 35-80mm f/4-5.6D")},
            {0x3E,0x48,0x3C,0x3C,0x24,0x24,0x3D,0x02, N_("Nikon"), N_("AF Nikkor 28mm f/2.8D")},
            {0x41,0x48,0x7c,0x7c,0x24,0x24,0x43,0x02, N_("Nikon"), N_("AF Nikkor 180mm f/2.8D IF-ED")},
            {0x42,0x54,0x44,0x44,0x18,0x18,0x44,0x02, N_("Nikon"), N_("AF Nikkor 35mm f/2D")},
            {0x43,0x54,0x50,0x50,0x0C,0x0C,0x46,0x02, N_("Nikon"), N_("AF Nikkor 50mm f/1.4D")},
            {0x46,0x3C,0x44,0x60,0x30,0x3C,0x49,0x02, N_("Nikon"), N_("AF Zoom-Nikkor 35-80mm f/4-5.6D N")},
            {0x47,0x42,0x37,0x50,0x2A,0x34,0x4A,0x02, N_("Nikon"), N_("AF Zoom-Nikkor 24-50mm f/3.3-4.5D")},
            {0x48,0x48,0x8E,0x8E,0x24,0x24,0x4B,0x02, N_("Nikon"), N_("AF-S Nikkor 300mm f/2.8D IF-ED")},
            {0x4A,0x54,0x62,0x62,0x0C,0x0C,0x4D,0x02, N_("Nikon"), N_("AF Nikkor 85mm f/1.4D IF")},
            {0x4C,0x40,0x37,0x6E,0x2C,0x3C,0x4F,0x02, N_("Nikon"), N_("AF Zoom-Nikkor 24-120mm f/3.5-5.6D IF")},
            {0x4D,0x40,0x3C,0x80,0x2C,0x3C,0x62,0x02, N_("Nikon"), N_("AF Zoom-Nikkor 28-200mm f/3.5-5.6D IF")},
            {0x4E,0x48,0x72,0x72,0x18,0x18,0x51,0x02, N_("Nikon"), N_("AF DC-Nikkor 135mm f/2D")},
            {0x4F,0x40,0x37,0x5C,0x2C,0x3C,0x53,0x06, N_("Nikon"), N_("IX-Nikkor 24-70mm f/3.5-5.6")},
            {0x53,0x48,0x60,0x80,0x24,0x24,0x60,0x02, N_("Nikon"), N_("AF Zoom-Nikkor 80-200mm f/2.8D ED")},
            {0x54,0x44,0x5C,0x7C,0x34,0x3C,0x58,0x02, N_("Nikon"), N_("AF Zoom-Micro Nikkor 70-180mm f/4.5-5.6D ED")},
            {0x56,0x48,0x5C,0x8E,0x30,0x3C,0x5A,0x02, N_("Nikon"), N_("AF Zoom-Nikkor 70-300mm f/4-5.6D ED")},
            {0x59,0x48,0x98,0x98,0x24,0x24,0x5D,0x02, N_("Nikon"), N_("AF-S Nikkor 400mm f/2.8D IF-ED")},
            {0x5A,0x3C,0x3E,0x56,0x30,0x3C,0x5E,0x06, N_("Nikon"), N_("IX-Nikkor 30-60mm f/4-5.6")},
            {0x5D,0x48,0x3C,0x5C,0x24,0x24,0x63,0x02, N_("Nikon"), N_("AF-S Zoom-Nikkor 28-70mm f/2.8D IF-ED")},
            {0x5E,0x48,0x60,0x80,0x24,0x24,0x64,0x02, N_("Nikon"), N_("AF-S Zoom-Nikkor 80-200mm f/2.8D IF-ED")},
            {0x5F,0x40,0x3C,0x6A,0x2C,0x34,0x65,0x02, N_("Nikon"), N_("AF Zoom-Nikkor 28-105mm f/3.5-4.5D IF")},
            {0x61,0x44,0x5E,0x86,0x34,0x3C,0x67,0x02, N_("Nikon"), N_("AF Zoom-Nikkor 75-240mm f/4.5-5.6D")},
            {0x63,0x48,0x2B,0x44,0x24,0x24,0x68,0x02, N_("Nikon"), N_("AF-S Nikkor 17-35mm f/2.8D IF-ED")},
            {0x64,0x00,0x62,0x62,0x24,0x24,0x6A,0x02, N_("Nikon"), N_("PC Micro-Nikkor 85mm f/2.8D")},
            {0x65,0x44,0x60,0x98,0x34,0x3C,0x6B,0x0A, N_("Nikon"), N_("AF VR Zoom-Nikkor 80-400mm f/4.5-5.6D ED")},
            {0x66,0x40,0x2D,0x44,0x2C,0x34,0x6C,0x02, N_("Nikon"), N_("AF Zoom-Nikkor 18-35mm f/3.5-4.5D IF-ED")},
            {0x67,0x48,0x37,0x62,0x24,0x30,0x6D,0x02, N_("Nikon"), N_("AF Zoom-Nikkor 24-85mm f/2.8-4D IF")},
            {0x68,0x42,0x3C,0x60,0x2A,0x3C,0x6E,0x06, N_("Nikon"), N_("AF Zoom-Nikkor 28-80mm f/3.3-5.6G")},
            {0x69,0x48,0x5C,0x8E,0x30,0x3C,0x6F,0x06, N_("Nikon"), N_("AF Zoom-Nikkor 70-300mm f/4-5.6G")},
            {0x6A,0x48,0x8E,0x8E,0x30,0x30,0x70,0x02, N_("Nikon"), N_("AF-S Nikkor 300mm f/4D IF-ED")},
            {0x6B,0x48,0x24,0x24,0x24,0x24,0x71,0x02, N_("Nikon"), N_("AF Nikkor ED 14mm f/2.8D")},
            {0x6D,0x48,0x8E,0x8E,0x24,0x24,0x73,0x02, N_("Nikon"), N_("AF-S Nikkor 300mm f/2.8D IF-ED II")},
            {0x6E,0x48,0x98,0x98,0x24,0x24,0x74,0x02, N_("Nikon"), N_("AF-S Nikkor 400mm f/2.8D IF-ED II")},
            {0x6F,0x3C,0xA0,0xA0,0x30,0x30,0x75,0x02, N_("Nikon"), N_("AF-S Nikkor 500mm f/4D IF-ED")},
            {0x70,0x3C,0xA6,0xA6,0x30,0x30,0x76,0x02, N_("Nikon"), N_("AF-S Nikkor 600mm f/4D IF-ED")},
            {0x72,0x48,0x4C,0x4C,0x24,0x24,0x77,0x00, N_("Nikon"), N_("Nikkor 45mm f/2.8 P")},
            {0x74,0x40,0x37,0x62,0x2C,0x34,0x78,0x06, N_("Nikon"), N_("AF-S Zoom-Nikkor 24-85mm f/3.5-4.5G IF-ED")},
            {0x75,0x40,0x3C,0x68,0x2C,0x3C,0x79,0x06, N_("Nikon"), N_("AF Zoom-Nikkor 28-100mm f/3.5-5.6G")},
            {0x76,0x58,0x50,0x50,0x14,0x14,0x7A,0x02, N_("Nikon"), N_("AF Nikkor 50mm f/1.8D")},
            {0x77,0x48,0x5C,0x80,0x24,0x24,0x7B,0x0E, N_("Nikon"), N_("AF-S VR Zoom-Nikkor 70-200mm f/2.8G IF-ED")},
            {0x78,0x40,0x37,0x6E,0x2C,0x3C,0x7C,0x0E, N_("Nikon"), N_("AF-S VR Zoom-Nikkor 24-120mm f/3.5-5.6G IF-ED")},
            {0x79,0x40,0x3C,0x80,0x2C,0x3C,0x7F,0x06, N_("Nikon"), N_("AF Zoom-Nikkor 28-200mm f/3.5-5.6G IF-ED")},
            {0x7A,0x3C,0x1F,0x37,0x30,0x30,0x7E,0x06, N_("Nikon"), N_("AF-S DX Zoom-Nikkor 12-24mm f/4G IF-ED")},
            {0x7B,0x48,0x80,0x98,0x30,0x30,0x80,0x0E, N_("Nikon"), N_("AF-S VR Zoom-Nikkor 200-400mm f/4G IF-ED")},
            {0x7D,0x48,0x2B,0x53,0x24,0x24,0x82,0x06, N_("Nikon"), N_("AF-S DX Zoom-Nikkor 17-55mm f/2.8G IF-ED")},
            {0x7F,0x40,0x2D,0x5C,0x2C,0x34,0x84,0x06, N_("Nikon"), N_("AF-S DX Zoom-Nikkor 18-70mm f/3.5-4.5G IF-ED")},
            {0x80,0x48,0x1A,0x1A,0x24,0x24,0x85,0x06, N_("Nikon"), N_("AF DX Fisheye-Nikkor 10.5mm f/2.8G ED")},
            {0x81,0x54,0x80,0x80,0x18,0x18,0x86,0x0E, N_("Nikon"), N_("AF-S VR Nikkor 200mm f/2G IF-ED")},
            {0x82,0x48,0x8E,0x8E,0x24,0x24,0x87,0x0E, N_("Nikon"), N_("AF-S VR Nikkor 300mm f/2.8G IF-ED")},
            {0x89,0x3C,0x53,0x80,0x30,0x3C,0x8B,0x06, N_("Nikon"), N_("AF-S DX Zoom-Nikkor 55-200mm f/4-5.6G ED")},
            {0x8A,0x54,0x6A,0x6A,0x24,0x24,0x8C,0x0E, N_("Nikon"), N_("AF-S VR Micro-Nikkor 105mm f/2.8G IF-ED")},
            {0x8B,0x40,0x2D,0x80,0x2C,0x3C,0x8D,0x0E, N_("Nikon"), N_("AF-S DX VR Zoom-Nikkor 18-200mm f/3.5-5.6G IF-ED")},
            {0x8C,0x40,0x2D,0x53,0x2C,0x3C,0x8E,0x06, N_("Nikon"), N_("AF-S DX Zoom-Nikkor 18-55mm f/3.5-5.6G ED")},
            {0x8D,0x44,0x5C,0x8E,0x34,0x3C,0x8F,0x0E, N_("Nikon"), N_("AF-S VR Zoom-Nikkor 70-300mm f/4.5-5.6G IF-ED")},
            {0x8F,0x40,0x2D,0x72,0x2C,0x3C,0x91,0x06, N_("Nikon"), N_("AF-S DX Zoom-Nikkor 18-135mm f/3.5-5.6G IF-ED")},
            {0x94,0x40,0x2D,0x53,0x2C,0x3C,0x96,0x06, N_("Nikon"), N_("AF-S DX Zoom-Nikkor 18-55mm f/3.5-5.6G ED II")},
            //#
            {0x06,0x3F,0x68,0x68,0x2C,0x2C,0x06,0x00, N_("Cosina"), N_("100mm F/3.5 Macro")},
            //#
            {0x26,0x48,0x11,0x11,0x30,0x30,0x1C,0x02, N_("Sigma"), N_("8mm F4 EX Circular Fisheye")},
            {0x48,0x3C,0x19,0x31,0x30,0x3C,0x4B,0x06, N_("Sigma"), N_("10-20mm F4-5.6 EX DC HSM")},
            {0x48,0x38,0x1F,0x37,0x34,0x3C,0x4B,0x06, N_("Sigma"), N_("12-24mm F4.5-5.6 EX Aspherical DG HSM")},
            {0x02,0x3F,0x24,0x24,0x2C,0x2C,0x02,0x00, N_("Sigma"), N_("14mm F3.5")},
            {0x48,0x48,0x24,0x24,0x24,0x24,0x4B,0x02, N_("Sigma"), N_("14mm F2.8 EX ASPHERICAL HSM")},
            {0x26,0x48,0x27,0x27,0x24,0x24,0x1C,0x02, N_("Sigma"), N_("15mm F2.8 EX Diagonal Fish-Eye")},
            {0x26,0x40,0x27,0x3F,0x2C,0x34,0x1C,0x02, N_("Sigma"), N_("15-30mm F3.5-4.5 EX Aspherical DG DF")},
            {0x48,0x48,0x2B,0x44,0x24,0x30,0x4B,0x06, N_("Sigma"), N_("17-35mm F2.8-4 EX DG  Aspherical HSM")},
            {0x26,0x54,0x2B,0x44,0x24,0x30,0x1C,0x02, N_("Sigma"), N_("17-35mm F2.8-4 EX ASPHERICAL")},
            {0x26,0x48,0x2D,0x50,0x24,0x24,0x1C,0x06, N_("Sigma"), N_("18-50mm F2.8 EX DC")},
            {0x26,0x40,0x2D,0x50,0x2C,0x3C,0x1C,0x06, N_("Sigma"), N_("18-50mm F3.5-5.6 DC")},
            {0x26,0x40,0x2D,0x70,0x2B,0x3C,0x1C,0x06, N_("Sigma"), N_("18-125mm F3.5-5.6 DC")},
            {0x26,0x40,0x2D,0x80,0x2C,0x40,0x1C,0x06, N_("Sigma"), N_("18-200mm F3.5-6.3 DC")},
            {0x26,0x58,0x31,0x31,0x14,0x14,0x1C,0x02, N_("Sigma"), N_("20mm F1.8 EX Aspherical DG DF RF")},
            {0x26,0x58,0x37,0x37,0x14,0x14,0x1C,0x02, N_("Sigma"), N_("24mm F1.8 EX Aspherical DG DF MACRO")},
            {0x02,0x46,0x37,0x37,0x25,0x25,0x02,0x00, N_("Sigma"), N_("24mm F2.8 Macro")},
            {0x26,0x48,0x37,0x56,0x24,0x24,0x1C,0x02, N_("Sigma"), N_("24-60mm F2.8 EX DG")},
            {0x26,0x54,0x37,0x5C,0x24,0x24,0x1C,0x02, N_("Sigma"), N_("24-70mm F2.8 EX DG Macro")},
            {0x26,0x40,0x37,0x5C,0x2C,0x3C,0x1C,0x02, N_("Sigma"), N_("24-70mm F3.5-5.6 ASPHERICAL HF")},
            {0x26,0x54,0x37,0x73,0x24,0x34,0x1C,0x02, N_("Sigma"), N_("24-135mm F2.8-4.5")},
            {0x26,0x48,0x3C,0x5C,0x24,0x24,0x1C,0x06, N_("Sigma"), N_("28-70mm F2.8 EX DG")},
            {0x26,0x48,0x3C,0x5C,0x24,0x30,0x1C,0x02, N_("Sigma"), N_("28-70mm F2.8-4 HIGH SPEED ZOOM")},
            {0x02,0x46,0x3C,0x5C,0x25,0x25,0x02,0x00, N_("Sigma"), N_("28-70mm F2.8")},
            {0x02,0x3F,0x3C,0x5C,0x2D,0x35,0x02,0x00, N_("Sigma"), N_("28-70mm F3.5-4.5 UC")},
            {0x26,0x40,0x3C,0x60,0x2C,0x3C,0x1C,0x02, N_("Sigma"), N_("28-80mm F3.5-5.6 Mini Zoom Macro II Aspherical")},
            {0x26,0x3E,0x3C,0x6A,0x2E,0x3C,0x1C,0x02, N_("Sigma"), N_("28-105mm F3.8-5.6 UC-III ASPHERICAL IF")},
            {0x26,0x40,0x3C,0x80,0x2C,0x3C,0x1C,0x02, N_("Sigma"), N_("28-200mm F3.5-5.6 Compact Aspherical Hyperzoom Macro")},
            {0x26,0x40,0x3C,0x80,0x2B,0x3C,0x1C,0x02, N_("Sigma"), N_("28-200mm F3.5-5.6 Compact Aspherical Hyperzoom Macro")},
            {0x26,0x41,0x3C,0x8E,0x2C,0x40,0x1C,0x02, N_("Sigma"), N_("28-300mm F3.5-6.3 DG MACRO")},
            {0x26,0x40,0x3C,0x8E,0x2C,0x40,0x1C,0x02, N_("Sigma"), N_("28-300mm F3.5-6.3 Macro")},
            {0x48,0x54,0x3E,0x3E,0x0C,0x0C,0x4B,0x06, N_("Sigma"), N_("30mm F1.4 EX DC HSM")},
            {0x02,0x40,0x44,0x73,0x2B,0x36,0x02,0x00, N_("Sigma"), N_("35-135mm F3.5-4.5 a")},
            {0x32,0x54,0x50,0x50,0x24,0x24,0x35,0x02, N_("Sigma"), N_("50mm F2.8 EX DG Macro")},
            {0x7A,0x47,0x50,0x76,0x24,0x24,0x4B,0x06, N_("Sigma"), N_("APO 50-150mm F2.8 EX DC HSM")},
            {0x48,0x3C,0x50,0xA0,0x30,0x40,0x4B,0x02, N_("Sigma"), N_("50-500mm F4-6.3 EX APO RF HSM")},
            {0x26,0x3C,0x54,0x80,0x30,0x3C,0x1C,0x06, N_("Sigma"), N_("55-200mm F4-5.6 DC")},
            {0x48,0x54,0x5C,0x80,0x24,0x24,0x4B,0x02, N_("Sigma"), N_("70-200mm F2.8 EX APO IF HSM")},
            {0x26,0x3C,0x5C,0x8E,0x30,0x3C,0x1C,0x02, N_("Sigma"), N_("70-300mm F4-5.6 DG MACRO")},
            {0x56,0x3C,0x5C,0x8E,0x30,0x3C,0x1C,0x02, N_("Sigma"), N_("70-300mm F4-5.6 APO Macro Super II")},
            {0x02,0x37,0x5E,0x8E,0x35,0x3D,0x02,0x00, N_("Sigma"), N_("75-300mm F4.5-5.6 APO")},
            {0x02,0x48,0x65,0x65,0x24,0x24,0x02,0x00, N_("Sigma"), N_("90mm F2.8 Macro")},
            {0x77,0x44,0x61,0x98,0x34,0x3C,0x7B,0x0E, N_("Sigma"), N_("80-400mm f4.5-5.6 EX OS")},
            {0x48,0x48,0x68,0x8E,0x30,0x30,0x4B,0x02, N_("Sigma"), N_("100-300mm F4 EX IF HSM")},
            {0x26,0x44,0x73,0x98,0x34,0x3C,0x1C,0x02, N_("Sigma"), N_("135-400mm F4.5-5.6 APO Aspherical")},
            {0x48,0x48,0x76,0x76,0x24,0x24,0x4B,0x06, N_("Sigma"), N_("150mm F2.8 EX DG APO Macro HSM")},
            {0x26,0x40,0x7B,0xA0,0x34,0x40,0x1C,0x02, N_("Sigma"), N_("APO 170-500mm F5-6.3 ASPHERICAL RF")},
            {0x48,0x4C,0x7D,0x7D,0x2C,0x2C,0x4B,0x02, N_("Sigma"), N_("APO MACRO 180mm F3.5 EX DG HSM")},
            {0x48,0x54,0x8E,0x8E,0x24,0x24,0x4B,0x02, N_("Sigma"), N_("APO 300mm F2.8 EX DG HSM")},
            {0x26,0x48,0x8E,0x8E,0x30,0x30,0x1C,0x02, N_("Sigma"), N_("APO TELE MACRO 300mm F4")},
            {0x02,0x2F,0x98,0x98,0x3D,0x3D,0x02,0x00, N_("Sigma"), N_("400mm F5.6 APO")},
            //#
            {0x03,0x43,0x5C,0x81,0x35,0x35,0x02,0x00, N_("Soligor"), N_("AF C/D ZOOM UMCS 70-210mm 1:4.5")},
            //#
            {0x00,0x40,0x18,0x2B,0x2C,0x34,0x00,0x06, N_("Tokina"), N_("AT-X 107 DX Fish-Eye -AF 10-17mm f/3.5-4.5")},
            {0x00,0x3C,0x1F,0x37,0x30,0x30,0x00,0x06, N_("Tokina"), N_("AT-X 124 AF PRO DX - AF 12-24mm f/4")},
            {0x00,0x40,0x2B,0x2B,0x2C,0x2C,0x00,0x02, N_("Tokina"), N_("AT-X 17 AF PRO - AF 17mm f/3.5")},
            {0x25,0x48,0x3C,0x5C,0x24,0x24,0x1B,0x02, N_("Tokina"), N_("AT-X 287 AF PRO SV 28-70mm F2.8")},
            {0x00,0x48,0x3C,0x60,0x24,0x24,0x00,0x02, N_("Tokina"), N_("AT-X 280 AF PRO 28-80mm F2.8 ASPHERICAL")},
            {0x00,0x48,0x50,0x72,0x24,0x24,0x00,0x06, N_("Tokina"), N_("AT-X 535 PRO DX - AF 50-135mm f/2.8")},
            {0x14,0x54,0x60,0x80,0x24,0x24,0x0B,0x00, N_("Tokina"), N_("AT-X 828 AF 80-200mm F2.8")},
            {0x24,0x44,0x60,0x98,0x34,0x3C,0x1A,0x02, N_("Tokina"), N_("AT-X 840 AF II 80-400mm F4.5-5.6")},
            {0x00,0x54,0x68,0x68,0x24,0x24,0x00,0x02, N_("Tokina"), N_("AT-X M100 PRO D - 100mm F2.8")},
            {0x14,0x48,0x68,0x8E,0x30,0x30,0x0B,0x00, N_("Tokina"), N_("AT-X 340 AF II 100-300mm F4")},
            {0x00,0x54,0x8E,0x8E,0x24,0x24,0x00,0x02, N_("Tokina"), N_("AT-X 300 AF PRO 300mm F2.8")},
            //#
            {0x00,0x36,0x1C,0x2D,0x34,0x3C,0x00,0x06, N_("Tamron"), N_("SP AF11-18mm F/4.5-5.6 Di II LD Aspherical (IF)")},
            {0x07,0x46,0x2B,0x44,0x24,0x30,0x03,0x02, N_("Tamron"), N_("SP AF17-35mm F/2.8-4 Di LD Aspherical (IF)")},
            {0x00,0x3F,0x2D,0x80,0x2B,0x40,0x00,0x06, N_("Tamron"), N_("AF18-200mm f/3.5-6.3 XR Di II LD Aspherical (IF)")},
            {0x00,0x3F,0x2D,0x80,0x2C,0x40,0x00,0x06, N_("Tamron"), N_("AF18-200mm f/3.5-6.3 XR Di II LD Aspherical (IF) MACRO")},
            {0x07,0x40,0x30,0x45,0x2D,0x35,0x03,0x02, N_("Tamron"), N_("AF19-35mm F3.5-4.5")},
            {0x45,0x41,0x37,0x72,0x2C,0x3C,0x48,0x02, N_("Tamron"), N_("SP AF24-135mm F3.5-5.6 AD ASPHERICAL(IF)MACRO")},
            {0x33,0x54,0x3C,0x5E,0x24,0x24,0x62,0x02, N_("Tamron"), N_("SP AF28-75mm F2.8 XR Di LD ASPHERICAL(IF)MACRO")},
            {0x10,0x3D,0x3C,0x60,0x2C,0x3C,0xD2,0x02, N_("Tamron"), N_("AF28-80mm f/3.5-5.6 Aspherical")},
            {0x00,0x48,0x3C,0x6A,0x24,0x24,0x00,0x02, N_("Tamron"), N_("SP AF28-105mm f/2.8")},
            {0x0B,0x3E,0x3D,0x7F,0x2F,0x3D,0x0E,0x02, N_("Tamron"), N_("AF28-200mm f/3.8-5.6D")},
            {0x0B,0x3E,0x3D,0x7F,0x2F,0x3D,0x0E,0x00, N_("Tamron"), N_("AF28-200mm f/3.8-5.6")},
            {0x4D,0x41,0x3C,0x8E,0x2B,0x40,0x62,0x02, N_("Tamron"), N_("AF28-300mm f/3.5-6.3 XR Di LD Aspherical (IF)")},
            {0x4D,0x41,0x3C,0x8E,0x2C,0x40,0x62,0x02, N_("Tamron"), N_("AF28-300mm f/3.5-6.3D")},
            {0x69,0x48,0x5C,0x8E,0x30,0x3C,0x6F,0x02, N_("Tamron"), N_("AF70-300mm F4-5.6 LD MACRO 1:2")},
            {0x32,0x53,0x64,0x64,0x24,0x24,0x35,0x02, N_("Tamron"), N_("SP AF90mm f/2.8 Di 1:1 Macro")},
            {0x00,0x4C,0x7C,0x7C,0x2C,0x2C,0x00,0x02, N_("Tamron"), N_("SP AF180mm F3.5 Di Model B01")},
            {0x20,0x3C,0x80,0x98,0x3D,0x3D,0x1E,0x02, N_("Tamron"), N_("AF200-400mm f/5.6 LD IF")},
            {0x00,0x3E,0x80,0xA0,0x38,0x3F,0x00,0x02, N_("Tamron"), N_("SP AF200-500mm f/5-6.3 Di LD (IF)")},
            {0x00,0x3F,0x80,0xA0,0x38,0x3F,0x00,0x02, N_("Tamron"), N_("SP AF200-500mm F5-6.3 Di")},
            //#
            {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01, N_("Manual Lens"), N_("No CPU")},
            {0x1E,0x5D,0x64,0x64,0x20,0x20,0x13,0x00, N_("Unknown"), N_("90mm F/2.5")},
            {0x2F,0x40,0x30,0x44,0x2C,0x34,0x29,0x02, N_("Unknown"), N_("20-35mm F/3.5-4.5D")},
            {0x12,0x3B,0x68,0x8D,0x3D,0x43,0x09,0x02, N_("Unknown"), N_("100-290mm F5.6-6.7")},
            //#
