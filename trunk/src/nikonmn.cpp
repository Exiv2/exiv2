...
//        TagInfo(0x0e00, "PrintIM", "PrintIM", "Print image matching", nikon3IfdId, makerTags, xxx, printValue),
                                               ...
                                               const Value& value)
    {
        ...
        //# List of AF F-Mount lenses - version 1.15
        //#-----------------------------------------
        ...
        fmountlens[] = {
            ...
            {0x18,0x40,0x44,0x72,0x2C,0x34,0x0E,0x00, "Nikon", "AF Zoom-Nikkor 35-135mm f/3.5-4.5"},
...
//#
            {0x07,0x46,0x2B,0x44,0x24,0x30,0x03,0x02, "Tamron", "SP AF 17-35mm f/2.8-4 Di"},
            ...
            {0x32,0x53,0x64,0x64,0x24,0x24,0x35,0x02, "Tamron", "SP AF 90mm f/2.8 Di 1:1 Macro"},
