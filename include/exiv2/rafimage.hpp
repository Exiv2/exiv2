...
class EXIV2API RafImage : public Image {
 public:
   ...
   */
  RafImage(std::unique_ptr<BasicIo> io, const ImageCtorParams& params);
  //@}
...
/*!
  @brief Create a new RafImage instance and return an auto-pointer to it.
         ...
         it will be deleted.
 */
EXIV2API Image::UniquePtr newRafInstance(std::unique_ptr<BasicIo> io, const ImageCtorParams& params);
