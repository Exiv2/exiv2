...
constexpr TagInfo MinoltaMakerNote::tagInfoCs7D_[] = {
    ...
    {0x004A, "FreeMemoryCardImages2", N_("Free Memory Card Images 2"), N_("Free memory card images 2"), IfdId::minoltaCs7DId,
     SectionId::makerTags, unsignedShort, 1, printValue},
...
constexpr TagInfo MinoltaMakerNote::tagInfoCs5D_[] = {
    ...
    {0x0054, "FreeMemoryCardImages2", N_("Free Memory Card Images 2"), N_("Free memory card images 2"), IfdId::minoltaCs5DId,
     SectionId::makerTags, unsignedShort, -1, printValue},
