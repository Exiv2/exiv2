...
constexpr TagDetails sonyHDRMode[] = {{0x00000, N_("Off")}, {0x10001, N_("Auto")}, {0x10010, "1"}, {0x10012, "2"},
                                      {0x10014, "3"},       {0x10016, "4"},        {0x10018, "5"}};

//! Lookup table to translate Sony model ID values to readable labels
constexpr TagDetails sonyModelId[] = {{2, "DSC-R1"},
                                      {256, "DSLR-A100"},
                                      {257, "DSLR-A900"},
                                      {258, "DSLR-A700"},
                                      {259, "DSLR-A200"},
...
constexpr TagDetails sonyExposureMode[] = {{0, N_("Auto")},
                                           {1, N_("Portrait")},
                                           {2, N_("Beach")},
                                           {3, N_("Sports")},
                                           {4, N_("Snow")},
...
constexpr TagDetails sonyWhiteBalance[] = {{0, N_("Auto")},
                                           {4, N_("Manual")},
                                           {5, N_("Daylight")},
                                           {6, N_("Cloudy")},
...
constexpr TagDetails sonyFocusMode[] = {{1, "AF-S"}, {2, "AF-C"}, {4, N_("Permanent-AF")}, {65535, N_("n/a")}};

//! Lookup table to translate Sony AF mode values to readable labels
constexpr TagDetails sonyAFMode[] = {{0, N_("Default")},       {1, N_("Multi AF")},         {2, N_("Center AF")},
                                     {3, N_("Spot AF")},       {4, N_("Flexible Spot AF")}, {6, N_("Touch AF")},
                                     {14, N_("Manual Focus")}, {15, N_("Face Detected")},   {65535, N_("n/a")}};

//! Lookup table to translate Sony AF illuminator values to readable labels
constexpr TagDetails sonyAFIlluminator[] = {{0, N_("Off")}, {1, N_("Auto")}, {65535, N_("n/a")}};

//! Lookup table to translate Sony macro mode values to readable labels
constexpr TagDetails sonyMacroMode[] = {{0, N_("Off")}, {1, N_("On")}, {2, N_("Close Focus")}, {65535, N_("n/a")}};
...
constexpr TagDetails sonySequenceNumber[] = {{0, N_("Single")}, {65535, N_("n/a")}};

//! Lookup table to translate Sony long exposure noise reduction values to readable labels
constexpr TagDetails sonyLongExposureNoiseReduction[] = {{0, N_("Off")}, {1, N_("On")}, {65535, N_("n/a")}};
...
//! Lookup table to translate Sony AF illuminator values to readable labels
constexpr TagDetails sonyAFIlluminatorCS[] = {{0, N_("Auto")}, {1, N_("Off")}};
