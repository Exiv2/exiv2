...
constexpr TagInfo OlympusMakerNote::tagInfo_[] = {
    ...
    {0x0209, "CameraID", N_("Camera ID"), N_("Camera ID data"), IfdId::olympusId, SectionId::makerTags, asciiString, -1,
     print0x0209},
    {0x020b, "ImageWidth2", N_("Image Width 2"), N_("Image width 2"), IfdId::olympusId, SectionId::makerTags, unsignedShort,
     -1, printValue},
    ...
    {0x102a, "SharpnessFactor2", N_("Sharpness Factor 2"), N_("Sharpness factor 2"), IfdId::olympusId, SectionId::makerTags,
     unsignedShort, -1, printValue},
