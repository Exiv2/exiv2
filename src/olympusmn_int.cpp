...
constexpr TagInfo OlympusMakerNote::tagInfoCs_[] = {
    ...
    {0x0305, "AFPointSelected", N_("AFPointSelected"), N_("AFPointSelected"), IfdId::olympusCsId, SectionId::makerTags,
     signedRational, -1, printValue},
    {0x0500, "WhiteBalance", N_("White Balance 2"), N_("White balance 2"), IfdId::olympusCsId, SectionId::makerTags, unsignedShort, -1,
     EXV_PRINT_TAG(olympusWhiteBalance)},
    {0x0501, "WhiteBalanceTemperature", N_("White Balance Temperature"), N_("White balance temperature"), IfdId::olympusCsId,
     SectionId::makerTags, unsignedShort, -1, printValue},
    {0x0502, "WhiteBalanceBracket", N_("White Balance Bracket"), N_("White balance bracket"), IfdId::olympusCsId, SectionId::makerTags,
     signedShort, -1, printValue},
    {0x0503, "CustomSaturation", N_("Custom Saturation"), N_("Custom saturation"), IfdId::olympusCsId, SectionId::makerTags, signedShort,
     -1, printValue},
    {0x0504, "ModifiedSaturation", N_("Modified Saturation"), N_("Modified saturation"), IfdId::olympusCsId, SectionId::makerTags,
     unsignedShort, -1, EXV_PRINT_TAG(olympusModifiedSaturation)},
    {0x0505, "ContrastSetting", N_("Contrast Setting"), N_("Contrast setting"), IfdId::olympusCsId, SectionId::makerTags, signedShort, -1,
     printValue},
    {0x0506, "SharpnessSetting", N_("Sharpness Setting"), N_("Sharpness setting"), IfdId::olympusCsId, SectionId::makerTags, signedShort,
     -1, printValue},
    {0x0507, "ColorSpace", N_("Color Space"), N_("Color space"), IfdId::olympusCsId, SectionId::makerTags, unsignedShort, -1,
     EXV_PRINT_TAG(olympusColorSpace)},
    {0x0509, "SceneMode", N_("Scene Mode"), N_("Scene mode"), IfdId::olympusCsId, SectionId::makerTags, unsignedShort, -1,
     EXV_PRINT_TAG(olympusSceneMode)},
    {0x050a, "NoiseReduction", N_("Noise Reduction"), N_("Noise reduction"), IfdId::olympusCsId, SectionId::makerTags, unsignedShort, -1,
     EXV_PRINT_TAG_BITMASK(olympusNoiseReduction)},
    {0x050b, "DistortionCorrection", N_("Distortion Correction"), N_("Distortion correction"), IfdId::olympusCsId, SectionId::makerTags,
     unsignedShort, -1, EXV_PRINT_TAG(olympusOffOn)},
    {0x050c, "ShadingCompensation", N_("Shading Compensation"), N_("Shading compensation"), IfdId::olympusCsId, SectionId::makerTags,
     unsignedShort, -1, EXV_PRINT_TAG(olympusOffOn)},
    {0x050d, "CompressionFactor", N_("Compression Factor"), N_("Compression factor"), IfdId::olympusCsId, SectionId::makerTags,
     unsignedRational, -1, printValue},
    {0x050f, "Gradation", N_("Gradation"), N_("Gradation"), IfdId::olympusCsId, SectionId::makerTags, signedShort, -1, print0x050f},
    {0x0520, "PictureMode", N_("Picture Mode"), N_("Picture mode"), IfdId::olympusCsId, SectionId::makerTags, unsignedShort, -1,
    ...
    {0x0521, "PictureModeSaturation", N_("Picture Mode Saturation"), N_("Picture mode saturation"), IfdId::olympusCsId,
     SectionId::makerTags, signedShort, -1, printValue},
    {0x0522, "PictureModeHue", N_("Picture Mode Hue"), N_("Picture mode hue"), IfdId::olympusCsId, SectionId::makerTags, unsignedShort,
     -1, printValue},
    {0x0523, "PictureModeContrast", N_("Picture Mode Contrast"), N_("Picture mode contrast"), IfdId::olympusCsId, SectionId::makerTags,
     signedShort, -1, printValue},
    {0x0524, "PictureModeSharpness", N_("Picture Mode Sharpness"), N_("Picture mode sharpness"), IfdId::olympusCsId, SectionId::makerTags,
     signedShort, -1, printValue},
    {0x0525, "PictureModeBWFilter", N_("Picture Mode BW Filter"), N_("Picture mode BW filter"), IfdId::olympusCsId, SectionId::makerTags,
     signedShort, -1, EXV_PRINT_TAG(olympusPictureModeBWFilter)},
    {0x0526, "PictureModeTone", N_("Picture Mode Tone"), N_("Picture mode tone"), IfdId::olympusCsId, SectionId::makerTags, signedShort,
     -1, EXV_PRINT_TAG(olympusPictureModeTone)},
    {0x0527, "NoiseFilter", N_("Noise Filter"), N_("Noise filter"), IfdId::olympusCsId, SectionId::makerTags, signedShort, -1,
     print0x0527},
    {0x0529, "ArtFilter", N_("Art Filter"), N_("Art filter"), IfdId::olympusCsId, SectionId::makerTags, unsignedShort, -1, print0x0529},
    {0x052c, "MagicFilter", N_("Magic Filter"), N_("Magic filter"), IfdId::olympusCsId, SectionId::makerTags, unsignedShort, -1,
     print0x0529},
    {0x0600, "DriveMode", N_("Drive Mode"), N_("Drive mode"), IfdId::olympusCsId, SectionId::makerTags, unsignedShort, -1, printValue},
    {0x0601, "PanoramaMode", N_("Panorama Mode"), N_("Panorama mode"), IfdId::olympusCsId, SectionId::makerTags, unsignedShort, -1,
     printValue},
    {0x0603, "Quality", N_("Image Quality 2"), N_("Image quality 2"), IfdId::olympusCsId, SectionId::makerTags, unsignedShort, -1,
