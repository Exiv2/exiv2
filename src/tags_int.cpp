...
constexpr GroupInfo groupInfo[] = {{ifdIdNotSet, "Unknown IFD", "Unknown", nullptr},
...
constexpr TagInfo ifdTagInfo[] = {
    ...
    {0x0150, "DotRange", N_("Dot Range"),
     ...
     N_("The component values that correspond to a 0% dot and 100% dot."), ifd0Id, imgStruct, unsignedByte, -1,
     printValue},  // TIFF tag
...
constexpr TagInfo exifTagInfo[] = {
    ...
    {0x9202, "ApertureValue", N_("Aperture"), N_("The lens aperture. The unit is the APEX value."), exifId, captureCond,
     unsignedRational, 1, print0x9202},
...
constexpr TagInfo mpfTagInfo[] = {
    {0xb000, "MPFVersion", N_("MPFVersion"), N_("MPF Version"), mpfId, mpfTags, asciiString, 0, printValue},
