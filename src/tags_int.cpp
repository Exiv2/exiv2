...
namespace Exiv2 {
    ...
    constexpr GroupInfo groupInfo[] = {
        ...
        { canonAmId,      "Makernote", "CanonAm",       CanonMakerNote::tagListAm     }, // new
    ...
    constexpr TagInfo ifdTagInfo[] = {
        ...
        {0x0109, "CellLength", N_("Cell Length"),
                N_("The length of the dithering or halftoning matrix used to create a "
                   "dithered or halftoned bilevel file."),
                ifd0Id, imgStruct, unsignedShort, 1, printValue}, // TIFF tag
        {0x010a, "FillOrder", N_("Fill Order"),
                N_("The logical order of bits within a byte"),
                ifd0Id, imgStruct, unsignedShort, 1, printValue}, // TIFF tag
        {0x010d, "DocumentName", N_("Document Name"),
        ...
        {0x0129, "PageNumber", N_("Page Number"),
        ...
        {0x0142, "TileWidth", N_("Tile Width"),
        ...
        {0x0154, "SMinSampleValue", N_("SMin Sample Value"),
                N_("This field specifies the minimum sample value."),
                ifd0Id, imgStruct, unsignedShort, -1, printValue}, // TIFF tag
        {0x0155, "SMaxSampleValue", N_("SMax Sample Value"),
                N_("This field specifies the maximum sample value."),
                ifd0Id, imgStruct, unsignedShort, -1, printValue}, // TIFF tag
        {0x0156, "TransferRange", N_("Transfer Range"),
        ...
        {0x0200, "JPEGProc", N_("JPEG Process"),
        ...
        {0x828f, "BatteryLevel", N_("Battery Level"),
        ...
        {0x829a, "ExposureTime", N_("Exposure Time"), N_("Exposure time, given in seconds."), ifd0Id, tiffEp, unsignedRational, 1, print0x829a}, // TIFF/EP tag
        {0x829d, "FNumber", N_("FNumber"), N_("The F number."), ifd0Id, tiffEp, unsignedRational, 1, print0x829d}, // TIFF/EP tag
        {0x83bb, "IPTCNAA", N_("IPTC/NAA"),
        ...
        {0x8822, "ExposureProgram", N_("Exposure Program"), N_("The class of the program used by the camera to set exposure when the picture is taken."), ifd0Id, tiffEp, unsignedShort, 1, print0x8822}, // TIFF/EP tag
        {0x8824, "SpectralSensitivity", N_("Spectral Sensitivity"), N_("Indicates the spectral sensitivity of each channel of the camera used."), ifd0Id, tiffEp, asciiString, 0, printValue}, // TIFF/EP tag
        {0x8825, "GPSTag", N_("GPS Info IFD Pointer"),
                ...
                ifd0Id, exifFormat, unsignedLong, 1, printValue},
        {0x8827, "ISOSpeedRatings", N_("ISO Speed Ratings"), N_("Indicates the ISO Speed and ISO Latitude of the camera or input device as specified in ISO 12232."), ifd0Id, tiffEp, unsignedShort, 0, print0x8827}, // TIFF/EP tag
        {0x8828, "OECF", N_("OECF"), N_("Indicates the Opto-Electric Conversion Function (OECF) specified in ISO 14524."), ifd0Id, tiffEp, undefined, 0, printValue}, // TIFF/EP tag
        {0x8829, "Interlace", N_("Interlace"), N_("Indicates the field number of multifield images."), ifd0Id, tiffEp, unsignedShort, 1, printValue}, // TIFF/EP tag
        ...
        {0x882b, "SelfTimerMode", N_("Self Timer Mode"), N_("Number of seconds image capture was delayed from button press."), ifd0Id, tiffEp, unsignedShort, 1, printValue}, // TIFF/EP tag
        {0x9003, "DateTimeOriginal", N_("Date Time Original"), N_("The date and time when the original image data was generated."), ifd0Id, tiffEp, asciiString, 20, printValue}, // TIFF/EP tag
        {0x9102, "CompressedBitsPerPixel", N_("Compressed Bits Per Pixel"), N_("Specific to compressed data; states the compressed bits per pixel."), ifd0Id, tiffEp, unsignedRational, 1, printFloat}, // TIFF/EP tag
        {0x9201, "ShutterSpeedValue", N_("Shutter Speed Value"), N_("Shutter speed."), ifd0Id, tiffEp, signedRational, 1, print0x9201}, // TIFF/EP tag
        {0x9202, "ApertureValue", N_("Aperture Value"), N_("The lens aperture."), ifd0Id, tiffEp, unsignedRational, 1, print0x9202}, // TIFF/EP tag
        {0x9203, "BrightnessValue", N_("Brightness Value"), N_("The value of brightness."), ifd0Id, tiffEp, signedRational, 1, printFloat}, // TIFF/EP tag
        {0x9204, "ExposureBiasValue", N_("Exposure Bias Value"), N_("The exposure bias."), ifd0Id, tiffEp, signedRational, 1, print0x9204}, // TIFF/EP tag
        {0x9205, "MaxApertureValue", N_("Max Aperture Value"), N_("The smallest F number of the lens."), ifd0Id, tiffEp, unsignedRational, 1, print0x9202}, // TIFF/EP tag
        {0x9206, "SubjectDistance", N_("Subject Distance"), N_("The distance to the subject, given in meters."), ifd0Id, tiffEp, signedRational, 1, print0x9206}, // TIFF/EP tag
        {0x9207, "MeteringMode", N_("Metering Mode"), N_("The metering mode."), ifd0Id, tiffEp, unsignedShort, 1, print0x9207}, // TIFF/EP tag
        {0x9208, "LightSource", N_("Light Source"), N_("The kind of light source."), ifd0Id, tiffEp, unsignedShort, 1, print0x9208}, // TIFF/EP tag
        {0x9209, "Flash", N_("Flash"), N_("Indicates the status of flash when the image was shot."), ifd0Id, tiffEp, unsignedShort, 1, EXV_PRINT_TAG(exifFlash)}, // TIFF/EP tag
        {0x920a, "FocalLength", N_("Focal Length"), N_("The actual focal length of the lens, in mm."), ifd0Id, tiffEp, unsignedRational, 1, print0x920a}, // TIFF/EP tag
        {0x920b, "FlashEnergy", N_("Flash Energy"), N_("Amount of flash energy (BCPS)."), ifd0Id, tiffEp, unsignedRational, 0, printValue}, // TIFF/EP tag
        {0x920c, "SpatialFrequencyResponse", N_("Spatial Frequency Response"), N_("SFR of the camera."), ifd0Id, tiffEp, undefined, 0, printValue}, // TIFF/EP tag
        {0x920d, "Noise", N_("Noise"), N_("Noise measurement values."), ifd0Id, tiffEp, undefined, 0, printValue}, // TIFF/EP tag
        {0x920e, "FocalPlaneXResolution", N_("Focal Plane X Resolution"), N_("Number of pixels per FocalPlaneResolutionUnit (37392) in ImageWidth direction for main image."), ifd0Id, tiffEp, unsignedRational, 1, printFloat}, // TIFF/EP tag
        {0x920f, "FocalPlaneYResolution", N_("Focal Plane Y Resolution"), N_("Number of pixels per FocalPlaneResolutionUnit (37392) in ImageLength direction for main image."), ifd0Id, tiffEp, unsignedRational, 1, printFloat}, // TIFF/EP tag
        {0x9210, "FocalPlaneResolutionUnit", N_("Focal Plane Resolution Unit"), N_("Unit of measurement for FocalPlaneXResolution(37390) and FocalPlaneYResolution(37391)."), ifd0Id, tiffEp, unsignedShort, 1, EXV_PRINT_TAG(tiffFocalPlaneResolutionUnit)}, // TIFF/EP tag
        {0x9211, "ImageNumber", N_("Image Number"), N_("Number assigned to an image, e.g., in a chained image burst."), ifd0Id, tiffEp, unsignedLong, 1, printValue}, // TIFF/EP tag
        {0x9212, "SecurityClassification", N_("Security Classification"), N_("Security classification assigned to the image."), ifd0Id, tiffEp, asciiString, 0, printValue}, // TIFF/EP tag
        {0x9213, "ImageHistory", N_("Image History"), N_("Record of what has been done to the image."), ifd0Id, tiffEp, asciiString, 0, printValue}, // TIFF/EP tag
        {0x9214, "SubjectLocation", N_("Subject Location"), N_("Indicates the location and area of the main subject in the overall scene."), ifd0Id, tiffEp, unsignedShort, 2, printValue}, // TIFF/EP tag
        {0x9215, "ExposureIndex", N_("Exposure Index"), N_("Encodes the camera exposure index setting when image was captured."), ifd0Id, tiffEp, unsignedRational, 0, printValue}, // TIFF/EP tag
        ...
        {0xc617, "CFALayout", N_("CFA Layout"),
        ...
        {0xcd2e, "SemanticName", N_("Semantic Name"),
        ...
        ////////////////////////////////////////
        // End of list marker
        {0xffff, "(UnknownIfdTag)", N_("Unknown IFD tag"),
                N_("Unknown IFD tag"),
    ...
    constexpr TagInfo exifTagInfo[] = {
        ...
        {0x9202, "ApertureValue", N_("Aperture"),
        ...
        {0x9405, "CameraElevationAngle", N_("Camera elevation angle"),
                ...
                exifId, captureCond, signedRational, 1, printValue}, // Exif 2.31
        {0xa000, "FlashpixVersion", N_("FlashPix Version"),
        ...
        {0xa407, "GainControl", N_("Gain Control"),
        ...
        // End of list marker
        {0xffff, "(UnknownExifTag)", N_("Unknown Exif tag"),
                N_("Unknown Exif tag"),
    ...
    constexpr TagInfo gpsTagInfo[] = {
        ...
        {0x001a, "GPSDestDistance", N_("GPS Destination Distance"),
        ...
        {0x001f, "GPSHPositioningError", N_("GPS Horizontal positioning error"),
                ...
                gpsId, gpsTags, unsignedRational, 1, printFloat},
        // End of list marker
        {0xffff, "(UnknownGpsTag)", N_("Unknown GPSInfo tag"),
    ...
    constexpr TagInfo mpfTagInfo[] = {
        {0xb000, "MPFVersion", N_("MPFVersion"),
                N_("MPF Version"),
                mpfId, mpfTags, asciiString, 0, printValue},
        {0xb001, "MPFNumberOfImages", N_("MPFNumberOfImages"),
                N_("MPF Number of Images"),
                mpfId, mpfTags, undefined, -1, printExifVersion},
        {0xb002, "MPFImageList", N_("MPFImageList"),
                N_("MPF Image List"),
                mpfId, mpfTags, asciiString, 0, printValue},
        {0xb003, "MPFImageUIDList", N_("MPFImageUIDList  "),
                N_("MPF Image UID List"),
                mpfId, mpfTags, unsignedLong, 1, printValue},
        {0xb004, "MPFTotalFrames", N_("MPFTotalFrames"),
                N_("MPF Total Frames"),
                mpfId, mpfTags, unsignedLong, 1, printValue},
        {0xb101, "MPFIndividualNum", N_("MPFIndividualNum"),
                N_("MPF Individual Num"),
                mpfId, mpfTags, unsignedLong, 1, printValue},
        {0xb201, "MPFPanOrientation", N_("MPFPanOrientation"),
                N_("MPFPanOrientation"),
                mpfId, mpfTags, unsignedLong, 1, printValue},
        {0xb202, "MPFPanOverlapH", N_("MPFPanOverlapH"),
                N_("MPF Pan Overlap Horizonal"),
                mpfId, mpfTags, unsignedLong, 1, printValue},
        {0xb203, "MPFPanOverlapV", N_("MPFPanOverlapV"),
                N_("MPF Pan Overlap Vertical"),
                mpfId, mpfTags, unsignedLong, 1, printValue},
        {0xb204, "MPFBaseViewpointNum", N_("MPFBaseViewpointNum"),
                N_("MPF Base Viewpoint Number"),
                mpfId, mpfTags, unsignedLong, 1, printValue},
        {0xb205, "MPFConvergenceAngle", N_("MPFConvergenceAngle"),
                N_("MPF Convergence Angle"),
                mpfId, mpfTags, unsignedLong, 1, printValue},
        {0xb206, "MPFBaselineLength", N_("MPFBaselineLength"),
                N_("MPF Baseline Length"),
                mpfId, mpfTags, unsignedLong, 1, printValue},
        {0xb207, "MPFVerticalDivergence", N_("MPFVerticalDivergence"),
                N_("MPF Vertical Divergence"),
                mpfId, mpfTags, unsignedLong, 1, printValue},
        {0xb208, "MPFAxisDistanceX", N_("MPFAxisDistanceX"),
                N_("MPF Axis Distance X"),
                mpfId, mpfTags, unsignedLong, 1, printValue},
        {0xb209, "MPFAxisDistanceY", N_("MPFAxisDistanceY"),
                N_("MPF Axis Distance Y"),
                mpfId, mpfTags, unsignedLong, 1, printValue},
        {0xb20a, "MPFAxisDistanceZ", N_("MPFAxisDistanceZ"),
                N_("MPF Axis Distance Z"),
                mpfId, mpfTags, unsignedLong, 1, printValue},
        {0xb20b, "MPFYawAngle", N_("MPFYawAngle"),
                N_("MPF Yaw Angle"),
                mpfId, mpfTags, unsignedLong, 1, printValue},
        {0xb20c, "MPFPitchAngle", N_("MPFPitchAngle"),
                N_("MPF Pitch Angle"),
                mpfId, mpfTags, unsignedLong, 1, printValue},
        {0xb20d, "MPFRollAngle", N_("MPFRollAngle"),
                N_("MPF Roll Angle"),
                mpfId, mpfTags, unsignedLong, 1, printValue},
        // End of list marker
        {0xffff, "(UnknownMpfTag)", N_("Unknown MPF tag"),
                N_("Unknown MPF tag"),
    ...
    constexpr TagInfo iopTagInfo[] = {
        ...
        {0x0002, "InteroperabilityVersion", N_("Interoperability Version"),
                N_("Interoperability version"),
                iopId, iopTags, undefined, -1, printExifVersion},
        {0x1000, "RelatedImageFileFormat", N_("Related Image File Format"),
                N_("File format of image file"),
                iopId, iopTags, asciiString, 0, printValue},
        {0x1001, "RelatedImageWidth", N_("Related Image Width"),
                N_("Image width"),
                iopId, iopTags, unsignedLong, 1, printValue},
        {0x1002, "RelatedImageLength", N_("Related Image Length"),
                N_("Image height"),
                iopId, iopTags, unsignedLong, 1, printValue},
        // End of list marker
        {0xffff, "(UnknownIopTag)", N_("Unknown Exif Interoperability tag"),
    ...
    constexpr TagInfo mnTagInfo[] = {
        ...
        // End of list marker
        {0xffff, "(UnknownMnTag)", N_("Unknown Exiv2 Makernote info tag"),
